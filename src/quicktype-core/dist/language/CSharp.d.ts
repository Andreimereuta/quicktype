...
export declare class NewtonsoftCSharpRenderer extends CSharpRenderer {
    ...
    private converterObject(converterName);
    private emitConverterClass();
    private emitDecoderTransformerCase(tokenCases, variableName, xfer, targetType, emitFinish);
    private emitConsume(value, consumer, targetType, emitFinish);
    private emitDecodeTransformer(xfer, targetType, emitFinish, variableName?);
    private stringCaseValue(t, stringCase);
    private emitTransformer(variable, xfer, targetType, emitFinish);

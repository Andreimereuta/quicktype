...
export declare class PikeRenderer extends ConvenienceRenderer {
    ...
    private emitBlock(line, f, opening?, closing?);
    private emitMappingBlock(line, f);
    private emitClassMembers(c);
    private emitInformationComment();
    private emitTopLevelTypedef(t, name);
    private emitTopLevelConverter(t, name);
    private emitEncodingFunction(c);
    private emitDecodingFunction(className, c);
}

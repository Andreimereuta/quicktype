...
export declare class JSONInput<T> implements Input<JSONSourceData<T>> {
    ...
    private addSample(topLevelName, sample);
    private setDescription(topLevelName, description);
    private addSamples(name, values, description);
...
export declare class InputData {
    ...
    private getOrAddInput<T>(kind, makeInput);
